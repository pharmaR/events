...
Discussion: Do you keep track and/or use `{riskmetric}` scores as part of your review process?

* **How do you feel about scores?** Do you care about them? Enter **"Care"** / **"Don't Care"** in the Chat.

--

Through our case study work, we've come to realize a lot of folks leverage risk categories for packages, deeming the **risk low, medium, or high**. And we added `{riskassessment}` features that allow you to set "risk decision thresholds" to automatically tag packages based on pkg score:

![](images/risk_score_threshold_high.png)
...
---
## (Zoom in on) Pkg Groups and Highly Downloaded
...
---
## (Zoom in on) Groups with fewer downloads
...
In the chat - say "b up" or "d down" to upweight or downweight a metric for example!



---
# Do you want the CRAN scoring data?

If you complete our survey, I'll email you the data & code to reproduce my analysis. Of course, you could write a script to do it yourself too. But it took me 11 hours to run on my laptop, so taking a 10-minute survey would be waaay easier!
